 ...
 */
@Embeddable
public class ResultadoEquipoPK implements Serializable {
    ...
    public ResultadoEquipoPK() {
    }

    public ResultadoEquipoPK(int idPartido, int idEquiposAJugar, int idEncuentro, int idEquipo, int idDisciplina, int idTorneo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ResultadoEquipoPK)) {
            return false;
        }
        ResultadoEquipoPK other = (ResultadoEquipoPK) object;
    ...
    public String toString() {
        return "entidades.ResultadoEquipoPK[ idPartido=" + idPartido + ", idEquiposAJugar=" + idEquiposAJugar + ", idEncuentro=" + idEncuentro + ", idEquipo=" + idEquipo + ", idDisciplina=" + idDisciplina + ", idTorneo=" + idTorneo + " ]";
    }
