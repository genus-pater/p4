...
public class PartidoPK implements Serializable {
    ...
    public PartidoPK(int idPartido, int idEquiposAJugar, int idEncuentro, int idEquipo, int idDisciplina, int idTorneo) {
    ...
    public String toString() {
        return "entidades.PartidoPK[ idPartido=" + idPartido + ", idEquiposAJugar=" + idEquiposAJugar + ", idEncuentro=" + idEncuentro + ", idEquipo=" + idEquipo + ", idDisciplina=" + idDisciplina + ", idTorneo=" + idTorneo + " ]";
    }
